...
在本项目中，座位编号由五位数组成。如01401号座位，0—科目 1—区域 4-楼层 01-编号。
...
2、登陆注册功能。我们采取邮箱验证码的方式进行登录和注册，避免使用者因忘记密码造成的各种麻烦。

3、定位签到。我们会根据使用者的地理位置来进行签到，判断其是否使用座位。

4、信用分管理机制，对预约而不到的以及走后不手动解除占用的人进行扣分，连续暗示学习和签退的进行加分，分数过低的人，如低于85分，其预约操作将延迟生效

### 项目地址
http://124.70.132.102:3000/
